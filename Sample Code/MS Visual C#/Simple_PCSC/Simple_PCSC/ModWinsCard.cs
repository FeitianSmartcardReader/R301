...
namespace Simple_PCSC
{
    ...
    public class ModWinsCard
    {
        ...
        [DllImport("winscard.dll")]
        public static extern int SCardControl(int hCard, int dwControlCode, ref byte lpInBuffer, int nInBufferSize, ref byte lpOutBuffer, int nOutBufferSize, ref int lpBytesReturned);
        ...
        public static string GetScardErrMsg(int ReturnCode)
        {
            switch (ReturnCode)
            {
                ...
                default:
                    return ("Unknown Error, Try plugging the reader!.");
            }
        }
